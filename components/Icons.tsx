...
export const BoldIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h8c2.21 0 4 1.79 4 4s-1.79 4-4 4H4V6zm4 4h4c1.1 0 2-.9 2-2s-.9-2-2-2H8v4z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 14h10c2.21 0 4 1.79 4 4s-1.79 4-4 4H4v-8zm4 4h6c1.1 0 2-.9 2-2s-.9-2-2-2H8v4z" />
    </svg>
);

export const ItalicIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 4v3h2.21l-3.42 8H6v3h8v-3h-2.21l3.42-8H18V4h-8z" />
    </svg>
);
...
export const UndoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 9h12c2.76 0 5 2.24 5 5s-2.24 5-5 5H7" />
    </svg>
);
...
export const RedoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M20 9H8c-2.76 0-5 2.24-5 5s2.24 5 5 5h11" />
    </svg>
);
...
export const TrashIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z" />
    </svg>
);

export const UploadIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 10v9h14v-9M12 3l-7 7h4v5h6v-5h4l-7-7z" />
    </svg>
);
...
export const H1Icon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M5 4v7h2V9h2v2h2V4h-2v3H7V4H5zm9 0v11h2V4h-2zm3 0h2v11h-2V4z" />
    </svg>
);

export const H2Icon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M5 4v7h2V9h2v2h2V4h-2v3H7V4H5zm9 0c-1.11 0-2 .89-2 2v2.5c0 .83-.67 1.5-1.5 1.5S9 9.33 9 8.5V8H7v.5c0 1.93 1.57 3.5 3.5 3.5s3.5-1.57 3.5-3.5V6c0-1.11-.89-2-2-2zm2 7h2v4h-2v-4zm-2 4h-2v4h2v-4z" />
    </svg>
);

export const H3Icon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M5 4v7h2V9h2v2h2V4h-2v3H7V4H5zm9 0c-1.11 0-2 .89-2 2v2c0 .55.45 1 1 1s1-.45 1-1V6h-2v2h-2V6c0-2.21 1.79-4 4-4s4 1.79 4 4v2c0 2.21-1.79 4-4 4h-2v-2h2c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z" />
    </svg>
);
...
export const ClipboardIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.042m-7.332 0c-.055.194-.084.4-.084.612v3.042m0 0a2.25 2.25 0 002.25 2.25h3a2.25 2.25 0 002.25-2.25V6.75m-7.332 0h7.332M4.5 12.75a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-7.5a2.25 2.25 0 00-2.25-2.25h-9a2.25 2.25 0 00-2.25 2.25v7.5z" />
    </svg>
);
